...
linux_amd64:
	podman run --env=GOOS=linux --env=GOARCH=amd64 -it repo.rcmd.space/dafuq:latest-linux-amd64 sh -c 'go get && go build; cp /opt/dafuq /opt/apps/dafuq/dafuq-linux_amd64'
